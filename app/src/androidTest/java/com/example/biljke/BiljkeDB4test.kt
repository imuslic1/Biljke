...
//ovdje stavite vas paket kao u prethodnim testovima

//Id-evi u klasama Biljka i BiljkaBitmap koji služe kao primary key neka budu označeni sa anotacijom
//@PrimaryKey(autoGenerate = true)

//Vrijednost ovih parametara postavite defaultno na null tako da se može praviti instanca klase bez proslijeđivanja id-a (id će biti generisan u samoj bazi prilikom dodavanja u tabelu)
//var id:Long?=null,

//U finalnim testovima sa kojima će biti pregledani vaši projekti na sličan način biće dodano još par provjera. Neke od njih će se odnositi na provjeru ispravnosti metode fixOfflineBiljka
